...
rotas.post('/emprestimos',emprestimos.realizarEmprestimo);
rotas.put('/emprestimos',emprestimos.atualizarEmprestimo);
rotas.delete('/emprestimos',emprestimos.excluirEmprestimo);
